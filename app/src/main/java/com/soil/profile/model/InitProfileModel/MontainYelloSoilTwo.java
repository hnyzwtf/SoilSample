...
public class MontainYelloSoilTwo extends BaseProfileModel implements OnGestureListener{

    private static float one = (float)5/90;
    private static float two = (float)10/90;
    private static float three = (float)20/90;
    private static float four = (float)40/90;
    private static float five = (float)50/90;

    private static float[] lines = {0, one, two, three, four, five, 1};
    int[] proLegendCode = {2, 1, 6, 9, 7, 11};
    String[] layerNameAndDepth = {"O\t ", "A\t ", "AB\t ", "B\t ", "C1\t ", "C2\t "};
...
//		setImageResource(R.drawable.transparent_backgroud_frame);
        ...
        canvasBitmap.drawLines(new float[]{0,0,width, 0, width, 0, width, height,
                width, height, 0, height, 0, height, 0, 0}, paint);
    ...
    public List<Map<String, Object>> getLayerInfo(float length){
        ...
        a.put("name", "腐殖质层(A)");
        a.put("length", length*5/90);
        infoList.add(a);
        Map<String, Object> ab = new HashMap<String, Object>();
        ab.put("name", "AB过渡层(AB)");
        ab.put("length", length*10/90);
        infoList.add(ab);
        Map<String, Object> b = new HashMap<String, Object>();
        b.put("name", "沉淀层(B)");
        b.put("length", length*20/90);
        infoList.add(b);
        Map<String, Object> c1 = new HashMap<String, Object>();
        c1.put("name", "母质质层1(C1)");
        c1.put("length", length*10/90);
        infoList.add(c1);
        Map<String, Object> c2 = new HashMap<String, Object>();
        c2.put("name", "母质质层2(C1)");
        c2.put("length", length*40/90);
        infoList.add(c2);
        return infoList;
    }
