...
public class SevenLayerCusMdl extends BaseProfileModel implements OnGestureListener{
    ...
    public SevenLayerCusMdl(Context context, float[] lines, String[] layerName, float sumDepth){
        super(context, lines);
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (fmlLines[4]- gap < event.getY() && event.getY() < fmlLines[4] + gap) {
                    ...
                    flag = 5;
                }else if (fmlLines[6]-gap < event.getY() && event.getY() <fmlLines[6] + gap) {
                    flag = 6;
                }
                break;
...
//			lynum = 0;
    ...
    public void onLongPress(MotionEvent event) {
        if (event.getY()> fmlLines[6]+20 && event.getY()<950) {
            lynum = 7;
        }else if (event.getY()> fmlLines[5]+20 && event.getY()<fmlLines[5]-20) {
            lynum = 6;
        }else if (event.getY()> fmlLines[4]+20 && event.getY()<fmlLines[4]-20) {
            lynum = 5;
