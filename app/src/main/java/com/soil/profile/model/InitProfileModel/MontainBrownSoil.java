...
public class MontainBrownSoil extends BaseProfileModel implements OnGestureListener{

    private static float one = (float)5/60;
    private static float two = (float)10/60;
    private static float three = (float)20/60;
    private static float four = (float)30/60;

    private static float[] lines = {0, one, two, three, four, 1};
    int[] proLegendCode = {2, 1, 6, 9, 11};
    String[] layerNameAndDepth = {"O\t ", "A\t ", "E\t ", "B\t ", "C\t "};
    ...
    @SuppressLint("ClickableViewAccessibility") public MontainBrownSoil(Context context){
        super(context, lines);
...
//			lynum = 0;
    ...
    public List<Map<String, Object>> getLayerInfo(float length){
        ...
        o.put("name", "枯枝落叶层(O)");
        o.put("length", length*5/60);
        infoList.add(o);
        Map<String, Object> a = new HashMap<String, Object>();
        a.put("name", "腐殖质层(A)");
        a.put("length", length*5/60);
        infoList.add(a);
        Map<String, Object> e = new HashMap<String, Object>();
        e.put("name", "淋溶层(E)");
        e.put("length", length*10/60);
        infoList.add(e);
        Map<String, Object> b = new HashMap<String, Object>();
        b.put("name", "沉淀层(B)");
        b.put("length", length*10/60);
        infoList.add(b);
        Map<String, Object> c = new HashMap<String, Object>();
        c.put("name", "母质质层(C)");
        c.put("length", length*30/60);
        infoList.add(c);
        return infoList;
    }
