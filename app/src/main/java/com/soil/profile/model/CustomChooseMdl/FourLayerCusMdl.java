...
public class FourLayerCusMdl extends BaseProfileModel implements OnGestureListener{
    ...
    public FourLayerCusMdl(Context context, float[] lines, String[] layerName, float sumDepth){
        super(context, lines);
