 ...
 */
public class AlternativeParamsActivity extends BaseActivity{
    private Toolbar toolbar;
    private String markerLongLat;//默认显示在coorUnaccessEdit中的坐标，注意，发送给服务器的坐标，经度在前，纬度在后
    ...
    * */
    ...
    {
        coorUnaccessEdit.setText(markerLongLat);//默认显示当前操作样点的坐标
    ...
    {
        coorUnaccess = coorUnaccessEdit.getText().toString();
            ...
            socketConn.setOnAsyncResponse(new AsyncResponse() {
                ...
                public void onCoorXYReceivedSuccess(List<String> listX, List<String> listY) {
                    if (alterSamples != null)
                    {
                        ...
                        ToastUtil.show(AlternativeParamsActivity.this,"可替代样点计算成功，即将返回至地图界面");
                        waitDialog.dismiss();
                        Intent intentToMain = new Intent(AlternativeParamsActivity.this, MainActivity.class);
                        intentToMain.putParcelableArrayListExtra("alterSampleList", alterSamples);
                        startActivity(intentToMain);
                    }
                    else {
                        ToastUtil.show(AlternativeParamsActivity.this,"计算失败！");
                        waitDialog.dismiss();
                    }
                ...
                public void onConnectServerFailed() {
                    ToastUtil.show(AlternativeParamsActivity.this,"连接服务器失败，请检查网络后重试");
                    waitDialog.dismiss();
                }
            });
    ...
    * */
    ...
    {
        AlertDialog.Builder dialog = new AlertDialog.Builder(AlternativeParamsActivity.this);
        dialog.setTitle("警告");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            case android.R.id.home:
                ...
                break;
            case R.id.action_ok:
                waitDialog = CustomWaitDialog.show(AlternativeParamsActivity.this, "计算中，请稍后...", true, null);
                sendRequest();
