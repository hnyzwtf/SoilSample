...
public class MontainYelloSoilThree extends BaseProfileModel implements OnGestureListener{

    private static float one = (float)5/60;
    private static float two = (float)15/60;
    private static float three = (float)20/60;
    private static float four = (float)50/60;

    private static float[] lines = {0, one, two, three, four, 1};
    int[] proLegendCode = {2, 1, 9, 10, 11};
    String[] layerNameAndDepth = {"O\t ", "A\t ", "B\t ", "BC\t ", "C\t "};
...
//			lynum = 0;
    ...
    public List<Map<String, Object>> getLayerInfo(float length){
        ...
        a.put("name", "腐殖质层(A)");
        a.put("length", length*10/60);
        infoList.add(a);
        Map<String, Object> b = new HashMap<String, Object>();
        b.put("name", "沉淀层(B)");
        b.put("length", length*5/60);
        infoList.add(b);
        Map<String, Object> bc = new HashMap<String, Object>();
        bc.put("name", "BC过渡层(BC)");
        bc.put("length", length*30/60);
        infoList.add(bc);
        Map<String, Object> c = new HashMap<String, Object>();
        c.put("name", "母质质层(C)");
        c.put("length", length*10/60);
        infoList.add(c);
        return infoList;
    }
    @Override
